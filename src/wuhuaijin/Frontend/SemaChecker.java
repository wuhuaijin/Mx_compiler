    ...
    public void visit(ProgNode node) throws SyntaxException {
        ...
        for (var i : defList) {
            if (i instanceof ClassDefNode) {
                ...
                for (var j : ((ClassDefNode) i).getFuncList()) {
                    methods.add(j.getFuncSymol(FuncSymbol.SymbolType.method));
                }
                FuncSymbol creator = ((ClassDefNode) i).getCreator() == null ? null : ((ClassDefNode) i).getCreator().getFuncSymol(FuncSymbol.SymbolType.creator);
        ...
        for (var i : defList){
            if (i instanceof FuncDefNode) {
                FuncSymbol func = ((FuncDefNode) i).getFuncSymol(FuncSymbol.SymbolType.func);
                try {
    ...
    public void visit(ClassDefNode node) throws SyntaxException {
        ...
        try {
            for (var i : memberList) {
                ...
                scope.declareSymbol(node.getLocation(), i.getVarSymbol(VarSymbol.SymbolType.member));
            }
        } catch (SyntaxException e) {
            System.out.println(e.getMessage());
            error = true;
        ...
        try {
            for (var i : funcList) {
                scope.declareSymbol(node.getLocation(), i.getFuncSymol(FuncSymbol.SymbolType.method));
            }
            for (var i : funcList) {
                i.accept(this);
            }
        ...
        try {
            if (creator != null){
                scope.declareSymbol(node.getLocation(), creator.getFuncSymol(FuncSymbol.SymbolType.creator));
